...
<html lang="en">
   ...
   <body>
      <nav class="navbar px-md-0 navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
         ...
         <div class="collapse navbar-collapse" id="navbarNavDropdown"  style="float: right!important;">
            <ul class="navbar-nav">
               ...
               <li class="nav-item">
                  <a class="nav-link active" href="industry.php">Industry</a>
               </li>
               <li class="nav-item">
         ...
         <div class="container">
            <div class="row no-gutters slider-text align-items-end justify-content-center">
               <div class="col-md-9 ftco-animate pb-5 text-center my-cover">
                  <h1 class="mb-3 bread">Industry</h1>
                  <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Industry </span></p>
               </div>
            </div>
         </div>
      </section>
      <br><!-- <center><h1>To be updated soon.</h1></center> -->
      <!-- <section class="ftco-section">
         ...
         <div class="col-md-4 text-center">
            		<div class="practice-area ftco-animate">
            			<div class="icon d-flex justify-content-center align-items-center">
            				<img src="images/gear.jpg" alt="" style="width:210px;position:relative;top:25px;">
         </div>
         <br><br>
            			<h3><a href="description.php">Construction</a></h3>
            			<a href="description.php" class="btn-custom d-flex align-items-center justify-content-center"><span class="ion-ios-arrow-round-forward"></span></a>
            		</div>
            	</div>
            	<div class="col-md-4 text-center">
            		<div class="practice-area ftco-animate">
         ...
         <br><br>
            			<h3><a href="description.php">Material Handling</a></h3>
            			<a href="description.php" class="btn-custom d-flex align-items-center justify-content-center"><span class="ion-ios-arrow-round-forward"></span></a>
            		</div>
         </div>
         <div class="col-md-4 text-center">
         ...
         <br><br>
            			<h3><a href="description.php">Food processing</a></h3>
            			<a href="description.php" class="btn-custom d-flex align-items-center justify-content-center"><span class="ion-ios-arrow-round-forward"></span></a>
            		</div>
         </div>
         <div class="col-md-4 text-center">
         ...
         <br><br>
            			<h3><a href="description.php">Chemical and Pharmaceuticals</a></h3>
            			<a href="description.php" class="btn-custom d-flex align-items-center justify-content-center"><span class="ion-ios-arrow-round-forward"></span></a>
            		</div>
            	</div>
            </div>
