<?php if(isset($_POST['download'])){ try { $servername="localhost"; $username="root"; $pass="Gaeyah4S00per"; $dbname="Gaeyah"; $catalog_name="Electric Motor"; $conn=new PDO("mysql:host=$servername;dbname=$dbname;charset=utf8", $username, $pass); $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
   ...
   header('Content-Disposition: attachment; filename="Electric Motor Brochure.pdf"');
   header("Content-Length: " . filesize("files/Electric Motor Brochure.pdf"));
   $fp = fopen("files/Electric Motor Brochure.pdf", "r");
   fpassthru($fp);
   fclose($fp);
   }
         ...
         <div class=container>
            <div class=row>
               <div class="col-lg-12 ftco-animate">
                  <p>
                     <img src=images/electric_motor.png alt class="img-fluid gear-pic">
                  </p>
                  <h2 class=mb-3>Characteristics:</h2>
                  <ul>
                     <li>Starting Time and Duty Cycle: Motors are designed for continuous (S1) Duty. Other types of duty (S2 to S9) can be offered on request. The motors can safely withstand 3 consecutive starts from cold condition & 2 consecutive starts from hot conditions.</li>
                     <li>Winding & Insulation for Inverter Duty Motors: Adequate insulation is provided to the windings to take care of high temperatures.</li>
                     <li>Cooling: All motors are totally enclosed Fan Cooled (TEFC) The cooling is affected by self-driven, bi-directional centrifugal fan protected by fan cover.</li>
                     <li>Degree Protection: All motors have IP55 degree of protection as per IS/IEC 60034-.</li>
                     <li>Rotor: Entire range of motors is fitted with dynamically balanced aluminium pressure die cast squirrel cage rotors.</li>
                     <li>Noise Level: Motors are designed for noise level well below the limits specified in IS: 12065. </li>
                    </ul>
