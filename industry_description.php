         ...
         <div class=container>
            <div class="row no-gutters slider-text align-items-end justify-content-center">
               <div class="col-md-9 ftco-animate pb-5 text-center my-cover">
                  <h1 class="mb-3 bread">First Industry</h1>
                  <p class=breadcrumbs><span class=mr-2><a href=index.php>Home <i class=ion-ios-arrow-forward></i></a></span> <span class=mr-2><a href=industry.php>Industry<i class=ion-ios-arrow-forward></i></a></span> <span>Industry 1 <i class=ion-ios-arrow-forward></i></span></p>
               </div>
            </div>
         </div>
      </section>
         ...
         <div class=container>
            <div class=row>
               <div class="col-lg-10 ftco-animate">
                  <p>
                     <img src=images/gear.jpg alt class=img-fluid>
                  </p>
                  <h2 class=mb-3>Industry Overview:</h2>
                  ...
                  <div class=row>
                     <div class=col-lg-6>
                        <h2 class="mb-3 mt-5">Heading 1:</h2>
                  ...
                  <br><br>
                  <p><a href=quote.php class="btn btn-primary">Request Free Quotation</a></p>
               </div>
            </div>
         </div>
         </div>
