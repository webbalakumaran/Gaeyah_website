            ...
            <ul class=navbar-nav>
               ...
               <li class="nav-item dropdown">
                  ...
                  <div class=dropdown-menu aria-labelledby=navbarDropdownMenuLink>
                     ...
                     <a class="dropdown-item active" href=news.php>News & Events</a>
                  </div>
               </li>
               <li class=nav-item>
         ...
         <div class=container>
            <div class="row no-gutters slider-text align-items-end justify-content-center">
               <div class="col-md-9 ftco-animate pb-5 text-center my-cover">
                  <h1 class="mb-3 bread">News & Events</h1>
                  <p class=breadcrumbs><span class=mr-2><a href=index.html>Home <i class=ion-ios-arrow-forward></i></a></span> <span>News & Events </span></p>
               </div>
            </div>
         </div>
      </section>
