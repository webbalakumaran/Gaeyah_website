         ...
         <div class="container">
            <div class="row no-gutters slider-text align-items-end justify-content-center">
               <div class="col-md-9 ftco-animate pb-5 text-center my-cover">
                  ...
                  <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a href="products.php">Products <i class="ion-ios-arrow-forward"></i></a></span> <span>Hypoid Gearbox</span></p>
               </div>
            </div>
         </div>
      </section>
