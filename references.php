      ...
      <nav class="navbar px-md-0 navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
         ...
         <div class="collapse navbar-collapse" id="navbarNavDropdown"  style="float: right!important;">
            <ul class="navbar-nav">
               ...
               <li class="nav-item">
                  <a class="nav-link active" href="references.php">Reference</a>
               </li>
               <li class="nav-item">
         ...
         <div class="container">
            <div class="row no-gutters slider-text align-items-end justify-content-center">
               <div class="col-md-9 ftco-animate pb-5 text-center my-cover">
                  ...
                  <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>References</span></p>
               </div>
            </div>
         </div>
      </section>
         ...
         <div class="container">
            <div class="row justify-content-center mb-5 pb-3">
               <div class="col-md-7 heading-section text-center ftco-animate fadeInUp ftco-animated">
                  ...
                  <h5>Our team at Gaeyah wishes to transmit knowledge of the gearbox industry to our valuable customers, partners and all interested stakeholders.</h5>
               </div>
            </div>
               ...
               <div class="col-md-4 d-flex ftco-animate fadeInUp ftco-animated">
                  <div class="blog-entry justify-content-end">
                     <div class="text px-4 py-4">
                        <h3 class="heading mb-0"><a href="files/technical gear gaeyah.pdf" target="_blank">Technical FAQ's on Gears</a></h3>
                     </div>
                     <div class="text p-4 float-right d-block" style="text-align:center">
                        <p><a href="files/technical gear gaeyah.pdf" class="btn btn-primary" target="_blank">Read more</a></p>
                     </div>
                  </div>
               </div>
               <div class="col-md-4 d-flex ftco-animate fadeInUp ftco-animated">
                  <div class="blog-entry justify-content-end">
                     <div class="text px-4 py-4">
                        <h3 class="heading mb-0"><a href="files/Gear Failure Analysis.pdf" target="_blank">Gear failure analysis</a></h3>
                     </div>
                     <div class="text p-4 float-right d-block" style="text-align:center">
                        <p><a href="files/Gear Failure Analysis.pdf" class="btn btn-primary"target="_blank">Read more</a></p>
                     </div>
                  </div>
               </div>
               <div class="col-md-4 d-flex ftco-animate fadeInUp ftco-animated">
                  <div class="blog-entry justify-content-end">
                     <div class="text px-4 py-4">
                        <h3 class="heading mb-0"><a href="files/Basics of gear Design.pdf" target="_blank">Basics of gear design</a></h3>
                     </div>
                     <div class="text p-4 float-right d-block" style="text-align:center">
                        <p><a href="files/Basics of gear Design.pdf" class="btn btn-primary" target="_blank">Read more</a></p>
                     </div>
                  </div>
               </div>
            </div>
